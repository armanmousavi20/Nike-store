...
import { IHighlight } from '../type'

const FlexContent: FC<IHighlight> = (props) => {
  return (
    <>
      <div
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <p className="xl:text-sm my-4 text-slate-900">{props.text}</p>
          <a
            href={props.url}
